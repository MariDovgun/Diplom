...
public class SolveAdminMenuCommand extends SolveCommand {

    private static final String ADMIN_LOGIN ="admin";
    private static final String ADMIN_PASSWORD ="admin";
    private static final String USER_LOGIN ="luke";
    private static final String USER_PASSWORD ="saul";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (task==null || !task.getPage().equals(TaskPageHolder.ADMIN_MENU_PAGE)){
    ...
    private String checkLogin(String login){
        if (login.equals(ADMIN_LOGIN)){
            return "";
        } else if(login.equals(USER_LOGIN)) {
            return "user login";
        } else {
            return "wrong login";
        }
